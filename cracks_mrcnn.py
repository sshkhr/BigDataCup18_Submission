...
class ShapesConfig(Config):
    ...
    NUM_CLASSES = 1 + 9  # background + 8 types of cracks
...
model.keras_model.save_weights("mask_rcnn_shapes_epoch_2.h5")
...
model.keras_model.save_weights("mask_rcnn_shapes_epoch_5.h5")
...
model.keras_model.save_weights("mask_rcnn_shapes_epoch_8.h5")
...
model.keras_model.save_weights("mask_rcnn_shapes_epoch_10.h5")
...
model.keras_model.save_weights("mask_rcnn_shapes_epoch_13.h5")
...
model.keras_model.save_weights("mask_rcnn_shapes_epoch_15.h5")
